...
//        GridPropertyDetails adjacentPropertyDetails;

//        adjacentPropertyDetails = GetGridPropertyDetails(gridPropertyDetails.gridX, gridPropertyDetails.gridY + 1);
//        if (adjacentPropertyDetails != null && adjacentPropertyDetails.daysSinceDug > -1)
//        {
...
//        adjacentPropertyDetails = GetGridPropertyDetails(gridPropertyDetails.gridX - 1, gridPropertyDetails.gridY);
//        if (adjacentPropertyDetails != null && adjacentPropertyDetails.daysSinceDug > -1)
//        {
...
//        #region Set approptiate tile based on whether surrounding tiles are dug or not
...
//        #endregion Set approptiate tile based on whether surrounding tiles are dug or not
//    }
...
//        foreach(SO_GridProperties so_GridProperties in so_gridPropertiesArray)
//        {
//            //Get dridPropertyDetails dictionary for scene
...
public class GridPropertiesManager : SingletonMonobehaviour<GridPropertiesManager>, ISaveable
{
    ...
    {
        // Remove ground decorations
        if (groundDecoration1 != null)
            groundDecoration1.ClearAllTiles();

        if (groundDecoration2 != null)
            groundDecoration2.ClearAllTiles();
    }
